...
setup(
    ...
    description='SO101 master node for reading Feetech motors and publishing ROS 2 topics.',
    license='MIT',
    entry_points={
        'console_scripts': [
            'so101_master_node = so101_master_pkg.so101_master_node:main',
        ],
    },
)
